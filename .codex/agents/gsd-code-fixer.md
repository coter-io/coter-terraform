...
if [ "$USE_WORKTREES" = "false" ]; then
  ...
  # #2647: create the worktree INSIDE the repo under the same `.codex/worktrees/`
  ...
  # `.gitignore` rule for `.codex/` (`.gitignore:12`). Uniqueness across
