...
metadata:
  short-description: "Guide existing codebase onboarding through mapping, doc ingest, and planning setup"
---

<codex_skill_adapter>
## A. Skill Invocation
- This skill is invoked by mentioning `$gsd-onboard`.
- Treat all user text after `$gsd-onboard` as `{{GSD_ARGS}}`.
...
<execution_context>
@/Users/majskiy/Documents/projects/coter/coter-terraform/.codex/gsd-core/workflows/onboard.md
