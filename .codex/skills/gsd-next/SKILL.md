...
metadata:
  short-description: "Smart entry — detect project state and route to the right next GSD action."
---
...
This is a launcher/router only. It never does the work itself. It reads project + workflow state via `node "$HOME/.codex/gsd-core/bin/gsd-tools.cjs" smart-entry --json`, shows a situation-appropriate menu, and hands off to an existing GSD command.
</objective>

<execution_context>
@/Users/majskiy/Documents/projects/coter/coter-terraform/.codex/gsd-core/workflows/smart-entry.md
...
<process>
Follow /Users/majskiy/Documents/projects/coter/coter-terraform/.codex/gsd-core/workflows/smart-entry.md. Detect the situation, present the menu, and dispatch exactly one command. Then stop.
</process>
