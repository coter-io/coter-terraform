...
- **Global scope**: `/Users/majskiy/Documents/projects/coter/coter-terraform/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/majskiy/Documents/projects/coter/coter-terraform/.claude/notes/`)
...
2. Glob `/Users/majskiy/Documents/projects/coter/coter-terraform/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/Users/majskiy/Documents/projects/coter/coter-terraform/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/majskiy/Documents/projects/coter/coter-terraform/.claude/notes/` — works in any directory
