...
```
Agent(
  prompt="Read /Users/majskiy/Documents/projects/coter/coter-terraform/.claude/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/majskiy/Documents/projects/coter/coter-terraform/.claude/gsd-core/templates/VALIDATION.md`
