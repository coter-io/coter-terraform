...
ones). Reference: @/Users/majskiy/Documents/projects/coter/coter-terraform/.claude/gsd-core/references/edge-probe.md.
...
# — NOT the consuming project's git root — falling back to git toplevel / /Users/majskiy/Documents/projects/coter/coter-terraform/.claude.
...
EDGE_PROBE_JS=$(for _c in \
  ...
  "/Users/majskiy/Documents/projects/coter/coter-terraform/.claude/gsd-core/bin/lib/edge-probe.cjs" \
  "/Users/majskiy/Documents/projects/coter/coter-terraform/.claude/bin/lib/edge-probe.cjs"; do
  [ -f "$_c" ] && { echo "$_c"; break; }
done)
...
requirement list). Reference: @/Users/majskiy/Documents/projects/coter/coter-terraform/.claude/gsd-core/references/prohibition-probe.md — the
...
Use the SPEC.md template from @/Users/majskiy/Documents/projects/coter/coter-terraform/.claude/gsd-core/templates/spec.md.
