...
# SSH options — set SSH_KEY=/path/to/key to use a non-default key
...
tunnel: ## Open SSH tunnel to OpenClaw gateway (localhost:18789)
	...
	@echo ""
	@ssh $(SSH_OPTS) -N -L 18789:127.0.0.1:18789 openclaw@$(SERVER_IP)
