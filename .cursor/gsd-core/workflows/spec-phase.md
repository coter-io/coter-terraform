...
ones). Reference: @/Users/majskiy/Documents/projects/coter/coter-terraform/.cursor/gsd-core/references/edge-probe.md.
...
# — NOT the consuming project's git root — falling back to git toplevel / /Users/majskiy/Documents/projects/coter/coter-terraform/.cursor.
...
EDGE_PROBE_JS=$(for _c in \
  ...
  "/Users/majskiy/Documents/projects/coter/coter-terraform/.cursor/gsd-core/bin/lib/edge-probe.cjs" \
  "/Users/majskiy/Documents/projects/coter/coter-terraform/.cursor/bin/lib/edge-probe.cjs"; do
  [ -f "$_c" ] && { echo "$_c"; break; }
done)
...
If `$APPLICABLE` is `0`, do NOT proceed silently: ask the author to confirm via conversational prompting
...
3. Resolve each with the user (conversational prompting; text mode → numbered list):
...
- Any `unresolved` → conversational prompting:
...
requirement list). Reference: @/Users/majskiy/Documents/projects/coter/coter-terraform/.cursor/gsd-core/references/prohibition-probe.md — the
...
4. **Resolve each surfaced (non-canon) prohibition** (conversational prompting; text mode → numbered list):
...
**Text mode (PROB-09):** per Step 5's text-mode rule, replace the conversational prompting menus above
with plain-text numbered lists — there is NO hard conversational prompting dependency, so the probe
...
Use the SPEC.md template from @/Users/majskiy/Documents/projects/coter/coter-terraform/.cursor/gsd-core/templates/spec.md.
