...
- .cursor/rules/ or ./.cursor/.cursor/rules/ (if exists — follow project-specific guidelines)
...
execute-phase's #683/#1369 guard). Cursor's `isolation="worktree"` forks new worktrees from
...
- ${STATE_PATH} (Project state)
- .cursor/rules/ or ./.cursor/.cursor/rules/ (Project instructions, if exists)
