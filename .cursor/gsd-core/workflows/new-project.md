...
// Model profile uses a two-question split because conversational prompting enforces a hard
...
Use template: /Users/majskiy/Documents/projects/coter/coter-terraform/.cursor/gsd-core/templates/research-project/STACK.md
</output>
...
Use template: /Users/majskiy/Documents/projects/coter/coter-terraform/.cursor/gsd-core/templates/research-project/FEATURES.md
</output>
...
Use template: /Users/majskiy/Documents/projects/coter/coter-terraform/.cursor/gsd-core/templates/research-project/ARCHITECTURE.md
</output>
...
Use template: /Users/majskiy/Documents/projects/coter/coter-terraform/.cursor/gsd-core/templates/research-project/PITFALLS.md
</output>
...
Use template: /Users/majskiy/Documents/projects/coter/coter-terraform/.cursor/gsd-core/templates/research-project/SUMMARY.md
...
- `.planning/ROADMAP.md`
- `.planning/STATE.md`
- `$INSTRUCTION_FILE` (runtime-derived via the shared `getProjectInstructionFile` policy: `AGENTS.md` for codex/opencode/kilo/kimi, `.github/copilot-instructions.md` for copilot, `GEMINI.md` for gemini/antigravity, `.claude/.cursor/rules/` for claude)
...
- [ ] `$INSTRUCTION_FILE` generated with GSD workflow guidance (runtime-derived via the shared `getProjectInstructionFile` policy — `AGENTS.md` for codex/opencode/kilo/kimi, `.github/copilot-instructions.md` for copilot, `GEMINI.md` for gemini/antigravity, `.claude/.cursor/rules/` for claude; an existing hand-crafted file without GSD markers is left untouched unless `--force`)
