...
conversational prompting: "Archive completed quick tasks into this milestone too?" with options: "Yes — archive quick tasks into v[X.Y]" | "Skip"
...
**If doesn't exist:** Create from template at `/Users/majskiy/Documents/projects/coter/coter-terraform/.cursor/gsd-core/templates/retrospective.md`.
