...
```markdown
Read /Users/majskiy/Documents/projects/coter/coter-terraform/.cursor/agents/gsd-ui-researcher.md for instructions.
...
Template: /Users/majskiy/Documents/projects/coter/coter-terraform/.cursor/gsd-core/templates/UI-SPEC.md
</output>
...
```markdown
Read /Users/majskiy/Documents/projects/coter/coter-terraform/.cursor/agents/gsd-ui-checker.md for instructions.
...
@/Users/majskiy/Documents/projects/coter/coter-terraform/.cursor/gsd-core/references/ui-consideration-probe.md.
...
# (#448) — NOT the consuming project's git root — falling back to git toplevel / /Users/majskiy/Documents/projects/coter/coter-terraform/.cursor.
...
UI_PROBE_JS=$(for _c in \
  ...
  "/Users/majskiy/Documents/projects/coter/coter-terraform/.cursor/gsd-core/bin/lib/ui-consideration-probe.cjs" \
  "/Users/majskiy/Documents/projects/coter/coter-terraform/.cursor/bin/lib/ui-consideration-probe.cjs"; do
  [ -f "$_c" ] && { echo "$_c"; break; }
done)
...
If `$APPLICABLE` is `0`, do NOT proceed silently: ask via conversational prompting ("The UI probe found no
...
So SURFACE the detected kinds to the user (conversational prompting) and ask whether any real element kind
...
conversational prompting — **Specify** (→ `resolved`, verification: explicit; write a concrete truth) / **Dismiss (reason required)** /
...
**Kind-confirmation under `--auto`.** The propose-then-confirm step above is an conversational prompting, so
under `--auto` it follows the spec-phase 5.5 convention (replace conversational prompting with Claude's
