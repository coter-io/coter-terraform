...
```
Agent(
  prompt="Read /Users/majskiy/Documents/projects/coter/coter-terraform/.cursor/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/majskiy/Documents/projects/coter/coter-terraform/.cursor/gsd-core/templates/VALIDATION.md`
