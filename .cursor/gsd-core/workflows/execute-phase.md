...
@/Users/majskiy/Documents/projects/coter/coter-terraform/.cursor/gsd-core/references/agent-contracts.md
@/Users/majskiy/Documents/projects/coter/coter-terraform/.cursor/gsd-core/references/context-budget.md
@/Users/majskiy/Documents/projects/coter/coter-terraform/.cursor/gsd-core/references/gates.md
</required_reading>
...
**Model resolution:** If `executor_model` is `"inherit"`, omit the `model=` parameter from all `Agent()` calls — do NOT pass `model="inherit"` to Agent. Omitting the `model=` parameter causes Cursor to inherit the orchestrator model automatically. Only set `model=` when `executor_model` is an explicit model name (e.g., `"claude-sonnet-5"`, `"claude-opus-4-8"`).

@/Users/majskiy/Documents/projects/coter/coter-terraform/.cursor/gsd-core/references/execute-phase-response-language.md
...
- Executor agents omit extended deviation rule examples and checkpoint examples from inline prompt — load on-demand via @/Users/majskiy/Documents/projects/coter/coter-terraform/.cursor/gsd-core/references/executor-examples.md
- Planner agents omit extended anti-pattern lists and specificity examples from inline prompt — load on-demand via @/Users/majskiy/Documents/projects/coter/coter-terraform/.cursor/gsd-core/references/planner-antipatterns.md
...
```
Pure doc-only / config-only / test-only tasks return `is_behavior_adding=false` and are exempt. When the gate trips, Read `/Users/majskiy/Documents/projects/coter/coter-terraform/.cursor/gsd-core/references/execute-mvp-tdd.md` for the exact halt report format.
</step>
...
2. For each plan (sequentially, ignoring wave grouping):
   ...
   c. **If "Execute":** Read and follow `/Users/majskiy/Documents/projects/coter/coter-terraform/.cursor/gsd-core/workflows/execute-plan.md` **inline**
...
@/Users/majskiy/Documents/projects/coter/coter-terraform/.cursor/gsd-core/references/execute-phase-wave-guard.md

@/Users/majskiy/Documents/projects/coter/coter-terraform/.cursor/gsd-core/references/execute-phase-context-guard.md
   ...
   Agent(
    ...
    description="Execute plan {plan_number} of phase {phase_number}",
     ...
     prompt="
       ...
       - `/Users/majskiy/Documents/projects/coter/coter-terraform/.cursor/gsd-core/references/checkpoints.md`
       - `/Users/majskiy/Documents/projects/coter/coter-terraform/.cursor/gsd-core/references/tdd.md`
       - `/Users/majskiy/Documents/projects/coter/coter-terraform/.cursor/gsd-core/references/worktree-path-safety.md`
       ${CONTEXT_WINDOW < 200000 ? '' : '- `/Users/majskiy/Documents/projects/coter/coter-terraform/.cursor/gsd-core/references/executor-examples.md`'}
       </execution_context>
...
4. **Wait for all agents in wave to complete.**
   ...
   **This fallback applies to all runtimes.** Cursor's Agent() backgrounds by
...
@/Users/majskiy/Documents/projects/coter/coter-terraform/.cursor/gsd-core/references/execute-phase-quota-recovery.md

@/Users/majskiy/Documents/projects/coter/coter-terraform/.cursor/gsd-core/references/execute-phase-between-wave-reset.md
...
**If gaps_found:**
@/Users/majskiy/Documents/projects/coter/coter-terraform/.cursor/gsd-core/references/execute-phase-requirement-revert.md
```
...
@/Users/majskiy/Documents/projects/coter/coter-terraform/.cursor/gsd-core/workflows/transition.md
</step>
