...
Key references:
- @/Users/majskiy/Documents/projects/coter/coter-terraform/.cursor/gsd-core/references/ui-brand.md (display patterns)
- @/Users/majskiy/Documents/projects/coter/coter-terraform/.cursor/agents/gsd-user-profiler.md (profiler agent definition)
- @/Users/majskiy/Documents/projects/coter/coter-terraform/.cursor/gsd-core/references/user-profiling.md (profiling reference doc)
</required_reading>
...
```bash
PROFILE_PATH="/Users/majskiy/Documents/projects/coter/coter-terraform/.cursor/gsd-core/USER-PROFILE.md"
...
```bash
cp "/Users/majskiy/Documents/projects/coter/coter-terraform/.cursor/gsd-core/USER-PROFILE.md" "/Users/majskiy/Documents/projects/coter/coter-terraform/.cursor/USER-PROFILE.backup.md"
```
...
✓ Stores profile at /Users/majskiy/Documents/projects/coter/coter-terraform/.cursor/gsd-core/USER-PROFILE.md
...
- The user-profiling reference doc at `/Users/majskiy/Documents/projects/coter/coter-terraform/.cursor/gsd-core/references/user-profiling.md`
...
Reference: @/Users/majskiy/Documents/projects/coter/coter-terraform/.cursor/gsd-core/references/user-profiling.md
...
Display: "✓ Profile written to /Users/majskiy/Documents/projects/coter/coter-terraform/.cursor/gsd-core/USER-PROFILE.md"
...
- options (ALL pre-selected by default):
  ...
  - "Global .cursor/rules/" -- "Add profile to /Users/majskiy/Documents/projects/coter/coter-terraform/.cursor/.cursor/rules/ for all projects"

**If no artifacts selected:** Display "No artifacts generated. Your profile is saved at /Users/majskiy/Documents/projects/coter/coter-terraform/.cursor/gsd-core/USER-PROFILE.md" and jump to step 10.
...
Display: "✓ Generated /gsd-dev-preferences at /Users/majskiy/Documents/projects/coter/coter-terraform/.cursor/skills/gsd-dev-preferences/SKILL.md"
...
Display: "✓ Added profile section to /Users/majskiy/Documents/projects/coter/coter-terraform/.cursor/.cursor/rules/"
...
```bash
BACKUP_PATH="/Users/majskiy/Documents/projects/coter/coter-terraform/.cursor/USER-PROFILE.backup.md"
```
...
Your profile:    /Users/majskiy/Documents/projects/coter/coter-terraform/.cursor/gsd-core/USER-PROFILE.md
```

Then list paths for each generated artifact:
```
Artifacts:
  ✓ /gsd-dev-preferences   /Users/majskiy/Documents/projects/coter/coter-terraform/.cursor/skills/gsd-dev-preferences/SKILL.md
  ✓ .cursor/rules/ section       <resolved claude_md_path, default ./.cursor/.cursor/rules/>
  ✓ Global .cursor/rules/        /Users/majskiy/Documents/projects/coter/coter-terraform/.cursor/.cursor/rules/
```

(Show the `claude_md_path` actually returned by the command — it defaults to `./.cursor/.cursor/rules/` but may be overridden by config or `--output`.)
