...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `/Users/majskiy/Documents/projects/coter/coter-terraform/.cursor/.gsd-surface.json`
(sibling to `/Users/majskiy/Documents/projects/coter/coter-terraform/.cursor/.gsd-profile`) and re-stages the active skills directory in place.
Skill dirs live at `/Users/majskiy/Documents/projects/coter/coter-terraform/.cursor/skills/gsd-*/`.
...
(`/Users/majskiy/Documents/projects/coter/coter-terraform/.cursor`), NOT the skills sub-directory (`/Users/majskiy/Documents/projects/coter/coter-terraform/.cursor/skills`).

This matches `installRuntimeArtifacts` and `uninstallRuntimeArtifacts`, which also
receive `/Users/majskiy/Documents/projects/coter/coter-terraform/.cursor` as `configDir`. The skill dirs themselves live at
`/Users/majskiy/Documents/projects/coter/coter-terraform/.cursor/skills/gsd-*/` because the `claude global` layout has `destSubpath =
'skills'` — they are derived from `configDir`, not the root for it.

```bash
# Cursor — global install
RUNTIME_CONFIG_DIR="${CLAUDE_CONFIG_DIR:-/Users/majskiy/Documents/projects/coter/coter-terraform/.cursor}"
SCOPE="global"
...
(i.e. `/Users/majskiy/Documents/projects/coter/coter-terraform/.cursor/.gsd-surface.json`).
...
<execution_context>
Surface state file: `/Users/majskiy/Documents/projects/coter/coter-terraform/.cursor/.gsd-surface.json`
Install profile marker: `/Users/majskiy/Documents/projects/coter/coter-terraform/.cursor/.gsd-profile`
Skill dirs: `/Users/majskiy/Documents/projects/coter/coter-terraform/.cursor/skills/gsd-*/`
Engine module: `/Users/majskiy/Documents/projects/coter/coter-terraform/.cursor/gsd-core/bin/lib/surface.cjs`
Cluster definitions: `/Users/majskiy/Documents/projects/coter/coter-terraform/.cursor/gsd-core/bin/lib/clusters.cjs`
</execution_context>
