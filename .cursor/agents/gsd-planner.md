...
@/Users/majskiy/Documents/projects/coter/coter-terraform/.cursor/gsd-core/references/mandatory-initial-read.md
...
**Project skills:** @/Users/majskiy/Documents/projects/coter/coter-terraform/.cursor/gsd-core/references/project-skills-discovery.md
- Load `rules/*.md` as needed during **planning**.
- Ensure plans account for project skill patterns and conventions.

**agent_skills:** self-load per @/Users/majskiy/Documents/projects/coter/coter-terraform/.cursor/gsd-core/references/agent-skills-bootstrap.md
</project_context>
...
@/Users/majskiy/Documents/projects/coter/coter-terraform/.cursor/gsd-core/references/planner-source-audit.md for full format, examples, and gap-handling rules.
...
@/Users/majskiy/Documents/projects/coter/coter-terraform/.cursor/gsd-core/references/planner-source-audit.md for constraint examples.
...
See @/Users/majskiy/Documents/projects/coter/coter-terraform/.cursor/gsd-core/references/planner-guidance.md for planning philosophy (Solo Developer workflow, Plans Are Prompts, Quality Degradation Curve, Ship Fast).
...
**<precondition>** (optional, one prose line): a runnable/checkable fact the task assumes that plan ordering does not guarantee — external setup (`user_setup`), a prior-phase artifact, or an env var. The executor asserts it before running the task and halts on unmet. Emission rules + the contract triad (precondition ↔ `<verify>`/`<done>` ↔ `must_haves.truths`): @/Users/majskiy/Documents/projects/coter/coter-terraform/.cursor/gsd-core/references/planner-preconditions.md.

**<reversibility>** (optional): `rating="reversible|costly|one-way"` + one-line rationale for a decision this task implements. `one-way` inserts a `checkpoint:decision` before this task; `costly` is flagged only; unsure means `reversible`. Rules: @/Users/majskiy/Documents/projects/coter/coter-terraform/.cursor/gsd-core/references/planner-reversibility.md

See @/Users/majskiy/Documents/projects/coter/coter-terraform/.cursor/gsd-core/references/planner-guidance.md for Task Types table, Task Sizing rules, Interface-First Task Ordering, and Specificity guidance.

## TDD Detection

**When `workflow.tdd_mode` is enabled:** Apply TDD heuristics aggressively — all eligible tasks MUST use `type: tdd`. Read @/Users/majskiy/Documents/projects/coter/coter-terraform/.cursor/gsd-core/references/tdd.md for gate enforcement rules and the end-of-phase review checkpoint format.
...
See @/Users/majskiy/Documents/projects/coter/coter-terraform/.cursor/gsd-core/references/planner-guidance.md for User Setup Detection protocol (external service indicators, env vars, dashboard config).

</task_breakdown>

<dependency_graph>

See @/Users/majskiy/Documents/projects/coter/coter-terraform/.cursor/gsd-core/references/planner-guidance.md for dependency graph building rules and file ownership for parallel execution.
...
Full rules: @/Users/majskiy/Documents/projects/coter/coter-terraform/.cursor/gsd-core/references/context-budget.md (Phase Sizing). Read before sizing.
...
<execution_context>
@/Users/majskiy/Documents/projects/coter/coter-terraform/.cursor/gsd-core/workflows/execute-plan.md
@/Users/majskiy/Documents/projects/coter/coter-terraform/.cursor/gsd-core/templates/summary.md
</execution_context>
...
See @/Users/majskiy/Documents/projects/coter/coter-terraform/.cursor/gsd-core/references/planner-guidance.md for a worked example and the `must_haves` YAML format.
...
Three types: **checkpoint:human-verify (90%)**, **checkpoint:decision (9%)**, **checkpoint:human-action (1% - rare)**. Full "use for" criteria and XML templates for each: @/Users/majskiy/Documents/projects/coter/coter-terraform/.cursor/gsd-core/references/checkpoints.md
...
@/Users/majskiy/Documents/projects/coter/coter-terraform/.cursor/gsd-core/references/planner-antipatterns.md
...
@/Users/majskiy/Documents/projects/coter/coter-terraform/.cursor/gsd-core/references/thinking-models-planning.md
...
See @/Users/majskiy/Documents/projects/coter/coter-terraform/.cursor/gsd-core/references/planner-guidance.md for return formats; gap-closure returns are artifact-based (#3440).

See @/Users/majskiy/Documents/projects/coter/coter-terraform/.cursor/gsd-core/references/planner-chunked.md for `## OUTLINE COMPLETE` and `## PLAN COMPLETE` return formats used in chunked mode.
